...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      { label: "Join", href: "/pro/join" },
      { label: "Apply", href: "/pro/apply" },
      { label: "FAQ", href: "/faq" },
    ],
  },
  {
...
function SocialIcon({ children, href, label }: { children: React.ReactNode; href: string; label: string }) {
  return (
    <a
      ...
      aria-label={label}
      className="inline-flex h-9 w-9 items-center justify-center rounded-full text-gray-400 transition-colors hover:bg-white/10 hover:text-white"
    >
      {children}
    </a>
  );
      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="mt-2 text-sm text-gray-400">
            Discounted beauty appointments in Greater Los Angeles
          </p>
        </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 md:flex-row">
          <p className="text-sm text-gray-400">&copy; {new Date().getFullYear()} BeautyLink, Inc.</p>
