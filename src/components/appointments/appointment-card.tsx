...
export function AppointmentCard({
  ...
  return (
    <Link href={`/appointments/${id}`} className="block">
      <TiltCard tiltAmount={6} scaleOnHover={1.03}>
        <div className="rounded-2xl border border-gray-100 bg-white shadow-premium overflow-hidden cursor-pointer">
          <div
