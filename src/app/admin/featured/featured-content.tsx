  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card variant="elevated" className="border-t-2 border-cta">
        ...
        <Card variant="elevated" className="border-t-2 border-accent">
          <CardContent className="pt-6 text-center">
        ...
        <Card variant="elevated" className="border-t-2 border-yellow-400">
          <CardContent className="pt-6 text-center">
