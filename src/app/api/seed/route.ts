...
export async function POST(req: NextRequest) {
  ...
  const demoUsers = [
    {
      ...
      profile: {
        ...
        bio: "Celebrity-trained stylist specializing in balayage, color correction, and precision cuts. 8+ years of experience in West LA salons.",
    ...
    },
    {
      ...
      profile: {
        ...
        bio: "Award-winning nail artist specializing in gel extensions, nail art, and natural nail care. Known for intricate designs and long-lasting results.",
    ...
    },
    {
      ...
      profile: {
        ...
        bio: "Certified lash extension specialist. Classic, hybrid, and volume sets. Obsessed with creating the perfect lash look for every eye shape.",
        ...
        totalBookings: 98,
        portfolioPhotos: [
          "https://images.unsplash.com/photo-1583001931096-959e9a1a6223?w=600&q=80&auto=format&fit=crop",
    ...
    },
    {
      ...
      profile: {
        ...
        bio: "Freelance makeup artist for weddings, events, and editorial. Trained at the Makeup Designory in Burbank. Fluent in English and Spanish.",
    ...
    },
    {
      ...
      profile: {
        ...
        bio: "Licensed esthetician specializing in hydrafacials, chemical peels, and acne treatments. Clean beauty advocate using organic, cruelty-free products.",
    ...
    },
    {
      ...
      profile: {
        ...
        bio: "Brow specialist: microblading, lamination, tinting, and shaping. I believe every face deserves the perfect frame.",
  ...
  const listings = [
    ...
    },
    {
      ...
      launchZone: "UCLA / Westwood",
      listingPhotoUrl: "https://images.unsplash.com/photo-1583001931096-959e9a1a6223?w=800&q=80&auto=format&fit=crop",
      viewCount: 52,
    },
    {
      userIndex: 3,
